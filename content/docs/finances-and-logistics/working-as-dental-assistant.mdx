...
Dental assistant regulations **vary by state**, so always check your local dental board or the [DANB State Map](https://www.danb.org/state-requirements).
...
You can get CE credits for licensing from the [ADAA website](https://www.dentalassistant.org/).
...
4. **Complete Continuing Education (CE)**
   - Free CE courses are available at [ADAA](https://www.dentalassistant.org/).
...
Check your state’s requirements via [DANB State Requirements Tool](https://www.danb.org/state-requirements)
