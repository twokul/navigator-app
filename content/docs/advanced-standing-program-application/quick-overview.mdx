...
detailed guide to applying to Advanced Standing Program, continue to [Detailed
Guide](/c/applying-to-advanced-standing/detailed-guide/introduction).

There are eight main steps to applying to Advanced Standing Program, outlined
below.

### Register and get your DENTPIN

This is your unique ID number for taking exams. Get your DENTPIN on the official
website [here]({{official.dentpin}}).

### Get a **course-by-course evaluation** of your foreign degree

All evaluations must go through
[ECE]({{official.ece}}). This is required to
...
[INBDE]({{official.inbde}}). You have six months to prepare from the
date of payment.

### Prepare For The Exam

More about materials and how to prepare for INBDE you can find
[here.](/c/related-paths-and-resources/inbde-study-materials)
...
website]({{official.toefl}}) to find tests for preparation. I highly
...
Support Service (PASS).**]({{official.pass}})
