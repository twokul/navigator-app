...
- In [CAAPID & Pass
  Guidance]({{social.facebook.caapid}})
  group you can find the latest and updated information for school admissions and
  more.
- [INBDE
  group]({{social.facebook.inbde}}) covers all the important sources
  that you will need for your INBDE Exam Preparations.

### Other Social Groups

- Find study partners, study material and files in [INBDE Telegram group]({{social.telegram.inbde}})
- Check out
  [/r/thefrenchdentiste]({{social.reddit.frenchDentiste}}) to chat
