...
1. Go to [ECE website](https://www.ece.org/ECE/Credential-Evaluations/US-Institutions)
2. Choose **Course by Course evaluation** type.
3. Review [required
   documents](https://www.ece.org/ECE/Credential-Evaluations/Documentation-Requirements)
   for your country
...
4. Get the required documents ready:
   ...
   - Translations can be submitted to ECE by mail with the rest of your
     ...
     payment).
5. Order a report (step 3 on the [ECE website](https://www.ece.org/ECE/Credential-Evaluations/US-Institutions)):
