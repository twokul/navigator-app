...
Once you complete the table with the important information, you can easily
compare programs and define the important elements you need to build up or
highlight in your application.

## Useful Resources

- [Studentdoctor North American Dental Schools
  Statistics](https://www.studentdoctor.net/how-to-get-into-dental-school-2/north-american-dental-schools/)
- [Studentdoctor DDS/DMD Profiles](https://dds.studentdoctor.net/)
- [American Dental Association (ADA) CODA Program Finder](https://www.ada.org/education/coda-program-finder)
- [Commission on Dental Accreditation (CODA)- find a
  program](https://coda.ada.org/find-a-program/search-dental-programs#sort=%40codastatecitysort%20ascending)
- [School Websites](https://www.ada.org/education/coda-program-finder)

CONGRATULATIONS! You are done with your first step! This was a crucial part
towards your future success! Now take a break and follow to the next step. Keep
your spreadsheet handy to later review the requirements.
